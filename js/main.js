...
$(document).ready(function () {
	$('#getResults').click(function() {
		$.get(apiURL + '/tally', function(data) {
			var tallyResults = "<thead><tr><th scope='col'>API</th><th scope='col'>Vote Count</th><th scope='col'>API ID</th></tr></thead>";
	...
	$('#getOptions').click(function() {
		$.get(apiURL + '/apis', function(data) {
			var optionsResults = "<thead><tr><th scope='col'>API</th><th scope='col'>API ID</th></tr></thead>";
			for (var i = 0; i < data.length; i++) {
				optionsResults += "<tr><td><button class='api'>" + data[i].name + "</td></button><td>" + "   " + data[i]._id + "</td></tr>";
